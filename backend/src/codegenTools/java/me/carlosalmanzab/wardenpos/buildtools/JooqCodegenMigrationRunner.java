...
/**
 * Standalone Utility (not a Spring bean) used exclusively during the Gradle build to generate a
 * migrated a SQLite file migrated as a source for JOOQ Codegen. This tool is excluded from the
 * final JAR/binary packaging
 */
